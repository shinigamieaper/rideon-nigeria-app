    ...
    <footer className="bg-slate-50 dark:bg-slate-900/80 border-t border-slate-200 dark:border-slate-800/50">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-16 pb-24">
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <RevealOnScroll
            as="div"
            className="flex-1 min-w-[240px] max-w-md mb-8 lg:mb-0"
            style={
              {
                "--tw-enter-opacity": "0",
          ...
          >
            <Link
              href="/"
              className="inline-flex items-center transition-opacity duration-300 hover:opacity-90 mb-5"
              aria-label="RideOn Nigeria home"
            >
              <Image
            ...
            <BlurText
              as="span"
              className="block mt-2 text-xs text-slate-500 dark:text-slate-500"
        ...
        >
          <div className="text-sm text-slate-500 dark:text-slate-400">
            <BlurText
              as="span"
              text={`© ${currentYear} RideOn Nigeria. All rights reserved.`}
              animateBy="words"
              direction="top"
              delay={20}
            />
          ...
          <div className="flex items-center gap-4">
            <Link
              ...
              className="p-2 rounded-md text-slate-500 dark:text-slate-400 hover:bg-slate-200 dark:hover:bg-slate-800 hover:text-slate-700 dark:hover:text-slate-200 transition-colors"
            ...
            <Link
              href="https://ng.linkedin.com/company/rideonnigeria"
              className="p-2 rounded-md text-slate-500 dark:text-slate-400 hover:bg-slate-200 dark:hover:bg-slate-800 hover:text-slate-700 dark:hover:text-slate-200 transition-colors"
              aria-label="LinkedIn"
            >
              <svg
