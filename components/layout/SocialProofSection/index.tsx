...
const testimonials: Testimonial[] = [
  {
    ...
    rating: 5,
    quote:
      "RideOn has been consistently reliable for my airport runs and important meetings. The drivers are professional, the cars are clean, and the experience feels premium from start to finish.",
  },
  {
    id: 2,
    name: "Chioma Nwosu",
    ...
    rating: 5,
    quote:
      "As someone who travels for meetings across Nigeria's major cities, pre-booking with RideOn gives me peace of mind. The drivers are always professional, the cars are clean, and I never have to worry about surge pricing. It's the only service I trust.",
  },
  {
    id: 3,
    name: "Tunde Alabi",
    ...
    rating: 5,
    quote:
      "Partnering with RideOn has transformed my driving career. The fixed bookings allow me to plan my day and guarantee my income. The company values professionalism and provides great support. It feels like a true partnership.",
  },
];
...
export default function SocialProofSection({
  ...
  const getCardStyles = (cardId: number) => {
    ...
    const order = isActive
      ? 3
      : cardId === (activeCardId % displayTestimonials.length) + 1
        ? 2
        : 1;
    ...
    return {
      ...
      transition:
        isDragging && isActive
          ? "none"
          : "transform 500ms ease-in-out, opacity 500ms ease-in-out, scale 500ms ease-in-out",
