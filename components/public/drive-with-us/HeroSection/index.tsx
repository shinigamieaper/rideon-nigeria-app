...
export default function HeroSection({
  backgroundImageUrl = "/hire-a-driver-pillar.png",
  className,
  ...rest
}: HeroSectionProps) {
  const enterVars = {
  ...
  return (
    <section
      className={[
        "relative isolate overflow-hidden py-24 sm:py-32 lg:py-0 lg:min-h-[60vh] lg:flex lg:items-center",
        className,
      ]
        .filter(Boolean)
        .join(" ")}
    ...
    >
      ...
      <div className="absolute inset-0 -z-20">
        <img
          ...
          alt="2D illustration: Professional Nigerian driver beside a premium sedan, representing driver careers"
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          <h1 className="text-4xl font-semibold tracking-tight text-white sm:text-5xl lg:text-6xl">
            <BlurText
              as="span"
              text="Build Your Driving Career with RideOn."
              animateBy="words"
              direction="top"
              delay={100}
            />
