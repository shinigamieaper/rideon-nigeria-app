          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            ...
            >
              ...
              <BlurText
                ...
                text="Access pre-booked reservations and contracted clients. No surge uncertainty—earn with confidence."
                animateBy="words"
                direction="top"
                delay={24}
              />
            ...
            >
              ...
              <h3 className="text-lg font-semibold leading-7 text-slate-900 dark:text-white">
                <BlurText
                  as="span"
                  text="Consistent, Pre‑Booked Jobs"
                  animateBy="words"
                  direction="top"
                  delay={120}
                />
              ...
              <BlurText
                as="p"
                className="mt-2 text-slate-600 dark:text-slate-400"
                text="Plan your week. Our pre-booked model provides a steady pipeline of reservations."
                animateBy="words"
                direction="top"
                delay={24}
              />
