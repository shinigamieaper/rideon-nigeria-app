    ...
    <>
      ...
      <section className="relative py-24 sm:py-32 overflow-hidden min-h-[600px]">
        ...
        <div className="absolute inset-0 -z-10">
          <Image
            src="/hero-about.png"
            alt="Nigerian professional woman seated in the back seat, checking her phone, brand-aligned illustration"
            fill
            priority
            sizes="100vw"
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <BlurText
              as="p"
              text="Connecting customers, drivers, partners, and businesses through safe, reliable, and professional transportation solutions across Nigeria."
