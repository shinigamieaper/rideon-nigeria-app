...
export interface WhyRideOnSectionProps
  extends React.ComponentPropsWithoutRef<"section"> {
  /** Controls the section background treatment */
  background?: "solid" | "tinted" | "transparent";
}

export default function WhyRideOnSection({
  className,
  background = "solid",
  ...rest
}: WhyRideOnSectionProps) {
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            >
              ...
              <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">
                <BlurText
                  as="span"
                  text="Every driver is rigorously vetted with comprehensive background checks and professional training. Your safety is our non-negotiable priority."
                  animateBy="words"
                />
              </p>
            </RevealOnScroll>
            ...
            >
              ...
              <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">
                <BlurText
                  as="span"
                  text="Your rental is confirmed instantly. We deliver your vehicle and driver on time, every time. No surprises, no cancellations."
                  animateBy="words"
                />
              </p>
            </RevealOnScroll>
            ...
            >
              ...
              <h3 className="text-lg font-semibold leading-8 text-slate-900 dark:text-white">
                <BlurText
                  as="span"
                  text="Unmatched Professionalism"
                  animateBy="words"
                />
              </h3>
              <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">
                <BlurText
                  as="span"
                  text="Well-maintained vehicles and courteous, experienced drivers. From economy to luxury, we deliver a premium rental experience."
                  animateBy="words"
                />
              </p>
            </RevealOnScroll>
            ...
            >
              ...
              <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">
                <BlurText
                  as="span"
                  text="The price you see is the price you pay. Fixed daily or half-day rates with no hidden costs or surprise fees."
                  animateBy="words"
                />
              </p>
            </RevealOnScroll>
